...
class opParams:
  def __init__(self):
    ...
    self.fork_params = {
                        ...
                        INDI_INNER_LOOP: Param([4.0, 4.0], VT.number, live=True),
                        INDI_OUTER_LOOP_BP: Param([0.,25], [list, float, int], live=True),
                        INDI_OUTER_LOOP: Param([3.0, 3.0], VT.number, live=True),
                        INDI_TIME_CONSTANT_BP: Param([0.,25], [list, float, int], live=True),
                        INDI_TIME_CONSTANT: Param([1.0, 1.0], VT.number, live=True),
                        INDI_ACTUATOR_EFFECTIVENESS_BP: Param([0.,25], [list, float, int], live=True),
                        INDI_ACTUATOR_EFFECTIVENESS: Param([1.0, 1.0], VT.number, live=True),
